...
'''
Comprobar qué puntos de interés son guardados con un conjunto de datos de ejemplo, por parte del tutorial usado 
para nuestro modelo final: Mask R-CNN y Mask Scoring R-CNN.
'''
if __name__ == "__main__":

    # Cargar imagen aleatoria del conjunto balloon dataset 
    ...
    # Convertir una imagen del conjunto balloon dataset de JSON a diccionario de Python

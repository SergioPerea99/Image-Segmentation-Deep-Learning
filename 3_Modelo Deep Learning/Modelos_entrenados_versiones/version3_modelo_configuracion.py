...
train_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='./Dataset/Images',
        ann_file='train/annotation_coco_tol10.json',
...
val_dataloader = dict(
    ...
    dataset=dict(
        type='CocoDataset',
        data_root='./Dataset/Images',
        ann_file='val/annotation_coco_tol10.json',
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='./Dataset/Images/val/annotation_coco_tol10.json',
    metric=['bbox', 'segm'],
    format_only=False,
    backend_args=None)
test_evaluator = dict(
...
max_epochs = 300
metainfo = dict(classes=('animal', ), palette=[(37, 177, 90)])
work_dir = './tutorial_exps_maskrcnn_preentrenado_300epochs_tol10'
seed = 0
